...
//	
      String username_values=email.getAttribute("values");
	 
      String pass_values=pass.getAttribute("values");
      
     Assert.assertEquals(username_values, "Sthakur");
     Assert.assertEquals("Qwerty@", pass_values);
